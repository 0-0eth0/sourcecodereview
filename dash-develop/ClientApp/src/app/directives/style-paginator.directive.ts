import {
  ...
  export class StylePaginatorDirective {
          ...
          for (let i = 0; i < nodeArray.length; i++) {
            if (nodeArray[i].nodeName === "BUTTON") {
              if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
                ...
                this.ren.setStyle(nodeArray[i], "color", "blue");
                this.ren.setStyle(nodeArray[i], "margin", ".5%");
                this.ren.setStyle(nodeArray[i], "background-color", "white");
                this.ren.setStyle(nodeArray[i], "border", "1px solid #ffffff");
                this.ren.setStyle(nodeArray[i], "color", "blue");
                this.ren.setStyle(nodeArray[i], "width", "24px");
                this.ren.setStyle(nodeArray[i], "height", "24px");
                this.ren.setStyle(nodeArray[i], "line-height", "24px");
              } else if (
                ...
                this.ren.setStyle(nodeArray[i], "background-color", "#269BFF");
                this.ren.setStyle(nodeArray[i], "color", "#FFFFFF");
                this.ren.setStyle(nodeArray[i], "width", "24px");
                this.ren.setStyle(nodeArray[i], "height", "24px");
                this.ren.setStyle(nodeArray[i], "line-height", "24px");
              }
    ...
    private createButton(i: any, pageIndex: number): any {
      ...
      this.ren.setStyle(linkBtn, "border", "1px solid #007CBF");
      this.ren.setStyle(linkBtn, "color", "blue");
